...
internal class RainfallKtTest {
    //......................................................
    @Test
    fun test1() {
        println("Fixed Tests: mean data")
        assertFuzzyEquals(mean("London", RainfallKtTest.data), 51.199999999999996)
    }

    @Test
    fun test2() {
        println("Fixed Tests: variance data")
        assertFuzzyEquals(variance("London", RainfallKtTest.data), 57.42833333333374)
    }

    @Test
    fun attemt_test3() {
        // sholud be -1 for some one but fails
        val data3 =
